...
def profile_configurations(
    dataset_name: str = "cityscapes-validation",
...
def main():
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="sama-coco-validation-10000",
        help="Name of the dataset to use (default: sama-coco-validation-10000)",
    )
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="segmentation_eval_performance.csv",
