...
class VideoSegmentationTests(unittest.TestCase):
    ...
    @drop_datasets
    def test_evaluate_video_segmentations_parallel(self):
        dataset = self._make_video_segmentation_dataset()
        ...
        # Verify frame-level fields
        self.assertIn("sequential_accuracy", dataset.get_frame_field_schema())
        self.assertIn("parallel_accuracy", dataset.get_frame_field_schema())
