...
class TestResolveOperatorTargetViewInputs(unittest.TestCase):
    def test_all_options(self):
        ...
        try:
            ...
            self.assertEqual(res, foo.constants.ViewTarget.SELECTED_SAMPLES)
    ...
    def test_no_options(self):
        ...
        try:
            ...
            self.assertEqual(res, foo.constants.ViewTarget.DATASET)
            self.assertEqual(len(inputs.properties), 0)
    ...
    def test_label_description_override(self):
        ...
        try:
            ...
            self.assertEqual(res, foo.constants.ViewTarget.DATASET_VIEW)
            prop = inputs.properties["view_target"]
            self.assertIsInstance(prop.type, types.Enum)
            self.assertListEqual(
                prop.type.values,
