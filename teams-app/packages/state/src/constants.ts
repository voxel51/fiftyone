...
export const FIFTYONE_ALLOW_LEGACY_ORCHESTRATORS_ENV_KEY =
  "FIFTYONE_ALLOW_LEGACY_ORCHESTRATORS";
export const FIFTYONE_APP_BANNER_TEXT_ENV_KEY = "FIFTYONE_APP_BANNER_TEXT";
