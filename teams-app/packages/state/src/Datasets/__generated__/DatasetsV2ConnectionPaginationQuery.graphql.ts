/**
 * @generated SignedSource<<301f0c484140f35e24a2d7002eb06236>>
...
export type DatasetsV2ConnectionPaginationQuery$variables = {
  after?: string | null;
  filter?: DatasetFilter | null;
  first: number;
  order?: DatasetOrderFieldsOrder | null;
};
export type DatasetsV2ConnectionPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"DatasetsV2ConnectionFragment">;
};
export type DatasetsV2ConnectionPaginationQuery = {
  response: DatasetsV2ConnectionPaginationQuery$data;
  variables: DatasetsV2ConnectionPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "DatasetsV2ConnectionPaginationQuery",
    "selections": [
      {
        "args": null,
        "kind": "FragmentSpread",
  ...
  "operation": {
    ...
    "selections": [
      ...
      },
      {
        ...
        "handle": "connection",
        "key": "DatasetsV2ConnectionFragment_datasetsConnection",
        "kind": "LinkedHandle",
        "name": "datasetsConnection"
      }
    ]
