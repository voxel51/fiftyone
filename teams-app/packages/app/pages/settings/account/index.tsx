...
export default function Account() {
  ...
  const handleAnalyticsTrackingChange = (event) => {
    window.localStorage.setItem(FIFTYONE_DO_NOT_TRACK_LS, event.target.checked ? 'false' : 'true');
  ...
  return (
    <SettingsLayout>
      ...
      <Container>
        <SectionHeader title="User Data Privacy" description="We track user activity within our app to improve the overall experience." />
        <FormControlLabel
          control={
            <Switch
