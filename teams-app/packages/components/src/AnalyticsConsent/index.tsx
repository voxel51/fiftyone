...
import { FIFTYONE_APP_ANONYMOUS_ANALYTICS_ENABLED, FIFTYONE_DO_NOT_TRACK_LS } from '@fiftyone/teams-state/src/constants';
...
export default function AnalyticsConsent() {
  ...
  return (
    <PinBottom>
      ...
      >
        <Grid padding={2}>
          <Typography variant="h6" marginBottom={1}>Help us improve FiftyOne</Typography>
