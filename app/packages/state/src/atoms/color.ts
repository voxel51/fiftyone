 ...
 */
export const useTemporalTagColor = () => useReverbValue(temporalTagColor);
 ...
 */
export const useValueColor = (path: string) => useReverbValue(valueColor(path));
...
export const usePathValueColors = (
  ...
  const colors = useReverbValue(pathValueColors(paths));
  const map = useReverbValue(colorMap);
  return useCallback(
