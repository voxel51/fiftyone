    ...
    const steps = [
        {
            ...
            description: 'Tailor your search experience to exactly the queries you want to perform',
        },
        {
            icon: SettingsIcon,
        ...
        },
        {
            ...
            description: 'View samples instantly using FiftyOne\'s advanced visualization capabilities',
        },
    ];
            ...
            <Box sx={{m: 2}}>
                <Box sx={{maxWidth: '750px', m: 'auto', p: 2}}>
                    ...
                    <Typography sx={{textAlign: 'center', mb: 8}} variant='h6'>
                        Data Lens allows you to connect FiftyOne directly
