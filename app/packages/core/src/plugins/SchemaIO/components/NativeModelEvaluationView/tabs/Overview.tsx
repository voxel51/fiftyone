            ...
            {compareKey && (
              <Stack sx={{ width: "100%" }}>
                ...
                <EvaluationPlot
                  data={[
                    {
                      z: compareEvaluation?.confusion_matrices?.default_matrix,
                      x: compareEvaluation?.confusion_matrices?.default_classes,
                      y: compareEvaluation?.confusion_matrices?.default_classes,
                      type: "heatmap",
                      colorscale: "viridis",
                      hovertemplate:
                        [
