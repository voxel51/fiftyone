    ...
    <Tooltip placement="top-center" text={tooltip}>
      ...
      >
        ...
        >
          ...
          {/* Mask face outline */}
          <path
            d="M2.5 3C2.5 1.9 3.4 1 4.5 1H14.5C15.6 1 16.5 1.9 16.5 3V8C16.5 12.7 14 15.5 9.5 17C5 15.5 2.5 12.7 2.5 8V3ZM4 2.5V8C4 11.8 6 14.2 9.5 15.4C13 14.2 15 11.8 15 8V2.5H4Z"
            fill="currentColor"
          />
          {/* Left eye */}
          <path
          ...
          />
          {/* Smile */}
          <path d="M7 10.5H12Q9.5 14 7 10.5Z" fill="currentColor" />
        </svg>
      </Square>
    </Tooltip>
  );
