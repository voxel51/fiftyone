...
import type { EpisodeDiagnosticState } from "../../../visualization/logs/diagnostic-console-state";
...
export interface DiagnosticProjectionRequest {
  ...
  /** Must be a new array instance on content change; never mutate in place. */
