...
export interface PlaybackShellProps {
 ...
 *     </PlaybackShell>
 */
const PlaybackShell: React.FC<PlaybackShellProps> = ({
  fileName,
  headerCaption,
  headerActions,
  addTileMenu,
...
interface LayoutProps {
  ...
  onTimelineDrawerOpenChange?: PlaybackShellProps["onTimelineDrawerOpenChange"];
  timelineDrawerMaxSize?: number;
  sharedImageWebGpuViews: boolean;
  className?: string;
