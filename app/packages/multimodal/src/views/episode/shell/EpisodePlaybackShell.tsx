...
import styles from "./EpisodePlaybackShell.module.css";
...
export interface EpisodePlaybackShellProps {
 ...
 *     </EpisodePlaybackShell>
 */
const EpisodePlaybackShell: React.FC<EpisodePlaybackShellProps> = ({
  fileName,
  headerCaption,
  headerActions,
  addTileMenu,
...
interface LayoutProps {
  ...
  leftSidebarWidth?: number;
  onLeftSidebarWidthChange?: (px: number) => void;
  onTagCreate?: EpisodePlaybackShellProps["onTagCreate"];
  onTagUpdate?: EpisodePlaybackShellProps["onTagUpdate"];
  onTagDelete?: EpisodePlaybackShellProps["onTagDelete"];
  onTimelineDrawerOpenChange?: EpisodePlaybackShellProps["onTimelineDrawerOpenChange"];
  timelineDrawerMaxSize?: number;
  sharedImageWebGpuViews: boolean;
  className?: string;
  /** Initial open state for the timeline drawer. */
  timelineDrawerDefaultOpen: boolean;
  decorateTrack?: EpisodePlaybackShellProps["decorateTrack"];
}
...
export default EpisodePlaybackShell;
