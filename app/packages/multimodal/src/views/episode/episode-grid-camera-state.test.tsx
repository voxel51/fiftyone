...
import {
  __resetEpisodeGridCameraPoseForTests,
  useEpisodeGridCameraPose,
} from "./episode-grid-camera-state";
...
describe("episode grid camera state", () => {
...
function CameraHarness({
  ...
  const [pose, setPose] = useEpisodeGridCameraPose(scopeKey, enabled);
