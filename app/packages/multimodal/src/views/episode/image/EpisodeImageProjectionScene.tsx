...
} from "../../../visualization/composition/gpu-point-cloud-projection-picker";
import {
...
export interface EpisodeImageProjectionSceneProps {
  readonly cameraModel: EpisodeCameraModel;
  readonly fit: "contain" | "cover";
  readonly imageHeight: number;
  readonly imageWidth: number;
  readonly layers: readonly EpisodeImageProjectionLayer[];
  readonly hoveredPoint: EpisodeHoverEcho | null;
...
interface PreparedProjectionLayer {
  ...
  readonly layer: EpisodeImageProjectionLayer;
...
export const EpisodeImageProjectionScene = forwardRef<
  GpuPointCloudProjectionPickerHandle,
  EpisodeImageProjectionSceneProps
>(function EpisodeImageProjectionScene(
  {
    cameraModel,
    fit,
    imageHeight,
...
export default EpisodeImageProjectionScene;
