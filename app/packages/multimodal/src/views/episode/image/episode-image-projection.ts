...
export const EPISODE_PROJECTION_MAX_POINTS = 150_000;
...
export interface EpisodeProjectionRotation {
  readonly w: number;
  readonly x: number;
  readonly y: number;
  readonly z: number;
...
export interface EpisodeProjectionTranslation {
  readonly x: number;
  readonly y: number;
  readonly z: number;
}
 ...
 */
export interface EpisodeProjectedPoints {
...
export function projectPointCloudToImage({
  calibration,
  colorWriter,
  maxPoints = EPISODE_PROJECTION_MAX_POINTS,
  positions,
  rotation,
  translation,
}: {
  ...
  readonly rotation: EpisodeProjectionRotation;
  readonly translation: EpisodeProjectionTranslation;
}): EpisodeProjectedPoints | null {
