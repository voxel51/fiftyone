...
export type EpisodeDataOperation =
...
export interface EpisodePlaybackPolicy {
...
export interface DerivedEpisodePlaybackPolicy extends EpisodePlaybackPolicy {
...
export const DEFAULT_EPISODE_PLAYBACK_POLICY: EpisodePlaybackPolicy = {
  lookaheadSeconds: 4,
...
export function deriveEpisodePlaybackPolicy(
...
export function episodeBatchReadPriority(
...
export function fillMissingLookaheadFrom({
  ...
  readonly lookaheadSeconds: number;
  readonly policy: DerivedEpisodePlaybackPolicy;
...
export interface EpisodeStreamWindowDecodeFailure {
