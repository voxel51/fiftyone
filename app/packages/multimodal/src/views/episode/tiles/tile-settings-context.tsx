 ...
 * controls only.
 */
export interface TileSettingsRegistration {
 ...
 */
const registry = createTileRegistry<TileSettingsRegistration>(
  "EpisodeTileSettings",
);

export const TileSettingsProvider = registry.Provider;
 ...
 * renders.
 */
export const useRegisterTileSettings = registry.useRegister;

/** The focused tile's settings registration, or null when none is mounted. */
export function useTileSettings(
  tileId: string | null | undefined,
): TileSettingsRegistration | null {
