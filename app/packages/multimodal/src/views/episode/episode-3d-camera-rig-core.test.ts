...
import type { CameraTargetResolution } from "./episode-3d-camera";
import {
...
describe("Episode3dCameraRigController follow composition", () => {
...
describe("Episode3dCameraRigController external-write protocol", () => {
...
describe("Episode3dCameraRigController gesture commits", () => {
...
describe("Episode3dCameraRigController anchor adoption", () => {
...
function createController(scene: ReturnType<typeof createScene>) {
  return new Episode3dCameraRigController(
    scene.camera,
    scene.controls,
    scene.invalidate,
    scene.callbacks,
...
function rigInputs(
  overrides: Partial<Episode3dCameraRigInputs> = {},
): Episode3dCameraRigInputs {
  return {
    adoptAnchor: null,
    mode: "position",
    sceneUpAxis: "z",
