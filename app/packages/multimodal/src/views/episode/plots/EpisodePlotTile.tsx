...
import { useEpisodePlotTileSeries } from "./episode-plot-tile-state";
import type { EpisodeTileProps } from "../tiles/episode-tile-types";
import { joinNumericSeries } from "./numeric-series-join";
import plotStyles from "./EpisodePlotTile.module.css";
    ...
    () =>
      seriesConfigs.map((config) => ({
        ...
        state: seriesByKey.get(
          episodeNumericSeriesKey(config.stream, config.fieldPath),
        ),
      })),
...
export default EpisodePlotTile;
