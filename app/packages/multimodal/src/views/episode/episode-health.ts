...
import type { Episode3dTransformGapWarning } from "./episode-3d-layers";
import {
  isFollowTrackingMode,
  type Episode3dTrackingMode,
} from "./episode-3d-camera";
import type { EpisodeStreamStatus } from "./episode-stream-status-state";
import type { EpisodeReferenceSelectionSource } from "./episode-3d-reference-selection";
...
function formatInterpolationGapWarnings(
  gaps: readonly Episode3dTransformGapWarning[],
): string {
  return gaps
