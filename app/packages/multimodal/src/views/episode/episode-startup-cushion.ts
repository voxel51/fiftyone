...
export interface EpisodeStartupCushionInputs {
  /**
...
export interface EpisodeStartupCushion {
  /**
 ...
 */
export function computeEpisodeStartupCushion(
  inputs: EpisodeStartupCushionInputs,
): EpisodeStartupCushion {
  const minimumSeconds = Math.max(0, inputs.minimumSeconds);
  const floor: EpisodeStartupCushion = {
