...
import { EpisodeGridStreamSelector } from "./EpisodeGridStreamSelector";
import {
...
describe("EpisodeGridStreamSelector", () => {
  beforeEach(() => {
    storedValues.clear();
    __resetEpisodeGridStreamStateForTests();
...
function RegisteredSelector() {
  const register = useRegisterEpisodeGridStreams();
  ...
  return <EpisodeGridStreamSelector />;
}
