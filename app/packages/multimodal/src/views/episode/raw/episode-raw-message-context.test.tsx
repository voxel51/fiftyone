...
import {
  EpisodeRawMessageBridge,
  EpisodeRawMessageProvider,
  useEpisodeRawMessageContext,
  type EpisodeRawMessageContextValue,
...
describe("EpisodeRawMessageBridge records", () => {
...
describe("EpisodeRawMessageBridge streams", () => {
...
function Harness({
  ...
  readonly contextRef: { current: EpisodeRawMessageContextValue | null };
  ...
  const body = (
    <EpisodeRawMessageProvider>
      <EpisodeDataStreamProvider>
        <FakeDataStream />
        {bridge ? (
          <EpisodeRawMessageBridge capability={client} sourceKey="test" />
        ) : null}
...
function ContextProbe({
  ...
  const value = useEpisodeRawMessageContext();
...
function createContextRef(): {
  current: EpisodeRawMessageContextValue | null;
} {
  return { current: null };
}
