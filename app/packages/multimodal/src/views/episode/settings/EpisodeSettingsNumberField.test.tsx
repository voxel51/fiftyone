...
import {
  ...
  type EpisodeSettingsNumberFieldProps,
} from "./EpisodeSettingsNumberField";
...
function Harness({
  ...
  onCommit,
  ...props
}: Omit<EpisodeSettingsNumberFieldProps, "ariaLabel" | "onCommit" | "value"> & {
  ...
  return (
    <EpisodeSettingsNumberField
      {...(props as EpisodeSettingsNumberFieldProps)}
      ariaLabel="Value"
...
describe("EpisodeSettingsNumberField", () => {
