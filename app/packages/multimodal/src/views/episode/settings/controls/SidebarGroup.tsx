...
import { settingsBooleanNoSpaceToggleProps } from "./settings-keyboard";
import { SettingsTooltip } from "./SettingsLabel";
import styles from "./SidebarGroup.module.css";

export interface SidebarGroupToggle {
...
const SidebarGroup: React.FC<{
  ...
  readonly toggle?: SidebarGroupToggle;
}> = ({
  children,
  ...
  return (
    <section className={styles.group}>
      <div className={styles.header}>
        ...
        {tooltip ? <SettingsTooltip tooltip={tooltip} /> : null}
        {toggle ? (
          <Toggle
