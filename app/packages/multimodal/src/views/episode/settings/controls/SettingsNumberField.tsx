...
interface SettingsNumberFieldBaseProps {
 ...
 */
export type SettingsNumberFieldProps = SettingsNumberFieldBaseProps &
  (
    | {
        readonly empty: "null";
 ...
 */
export function SettingsNumberField(props: SettingsNumberFieldProps) {
  const {
    ariaLabel,
    commitOn = "change",
    disabled = false,
