...
import type { EpisodeTransformGapWarning } from "../../status/episode-health";
...
export type Episode3dTransformGapWarning = EpisodeTransformGapWarning;

export interface Episode3dLayerBuildResult {
  ...
  readonly largeInterpolationGaps: readonly Episode3dTransformGapWarning[];
...
function buildSceneAnnotationLayer({
  ...
  readonly playbackFrame: EpisodeStreamPlaybackFrame<SceneUpdateVisualization>;
