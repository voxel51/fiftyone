...
describe("selectEpisode3dSceneSnapshot", () => {
...
function readyHeld(): HeldEpisode3dSceneSnapshot<string> {
  return {
    definitiveMissingSinceMs: null,
    key: KEY,
    retainable: true,
...
function select({
  ...
  readonly held?: HeldEpisode3dSceneSnapshot<string> | null;
  readonly key?: string;
  readonly nowMs?: number;
  readonly readiness?: "ready" | "pending" | "definitiveMissing";
}) {
  return selectEpisode3dSceneSnapshot({
    current,
