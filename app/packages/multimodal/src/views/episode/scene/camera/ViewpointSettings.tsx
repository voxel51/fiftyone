...
import { useScene3dViewpoint } from "./scene-3d-viewpoint-context";
...
const CAMERA_NAVIGATION_OPTIONS: {
  label: string;
  value: Scene3dCameraNavigationMode;
}[] = [
...
const ViewpointSettings: React.FC<{
  readonly tileId: string | null;
}> = ({ tileId }) => {
  const viewpoint = useScene3dViewpoint(tileId);
  ...
  return (
    <SidebarGroup defaultExpanded={false} summary={summary} title="Viewpoint">
              ...
              <RadioGroup
                ...
                onChange={(value) =>
                  viewpoint.controller.setCameraNavigationMode(
                    value as Scene3dCameraNavigationMode,
                  )
                }
...
export default ViewpointSettings;
