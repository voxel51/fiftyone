...
import {
  Episode3dCameraRigController,
  type Episode3dCameraRigCallbacks,
  type Episode3dCameraRigInputs,
  type RigCameraHandle,
  type RigControlsHandle,
} from "./episode-3d-camera-rig-core";

export type Episode3dCameraRigProps = Episode3dCameraRigInputs &
  Episode3dCameraRigCallbacks;

/**
 * R3F binding for {@link Episode3dCameraRigController}: mounts inside the 3D
 ...
 */
export function Episode3dCameraRig(props: Episode3dCameraRigProps) {
  ...
  const controllerRef = useRef<Episode3dCameraRigController | null>(null);
  ...
  useLayoutEffect(() => {
    ...
    const controller = new Episode3dCameraRigController(
...
function rigInputs(props: Episode3dCameraRigProps): Episode3dCameraRigInputs {
  return {
