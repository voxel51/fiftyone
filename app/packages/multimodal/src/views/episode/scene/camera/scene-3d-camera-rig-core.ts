 ...
 */
export interface Scene3dCameraRigInputs {
  /**
...
export interface Scene3dCameraRigCallbacks {
   ...
   */
  readonly onPoseSample: (sample: Scene3dCameraRigSample) => void;
}
 ...
 */
export class Scene3dCameraRigController {
  private anchor: Scene3dCameraTrackingAnchor | null = null;
  /**
  ...
  private inputs: Scene3dCameraRigInputs;
  private lastAdoptedAnchor: Scene3dCameraTrackingAnchor | null = null;
  ...
  constructor(
    ...
    private readonly callbacks: Scene3dCameraRigCallbacks,
    initialInputs: Scene3dCameraRigInputs,
  ) {
  ...
  getAnchor(): Scene3dCameraTrackingAnchor | null {
    return this.anchor;
  }
   ...
   */
  sync(inputs: Scene3dCameraRigInputs): void {
    if (this.disposed) {
      return;
    }
  ...
  private anchorMatchesInputs(anchor: Scene3dCameraTrackingAnchor): boolean {
  ...
  private compose(targetPose: Scene3dCameraTargetPose): void {
