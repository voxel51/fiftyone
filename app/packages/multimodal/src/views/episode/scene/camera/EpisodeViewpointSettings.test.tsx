...
import { createEpisode3dViewpointStore } from "./episode-3d-viewpoint";

afterEach(() => cleanup());

describe("EpisodeViewpointSettings", () => {
...
function renderSettings(controller: Episode3dViewpointController) {
  return render(
    <Episode3dViewpointProvider>
      <RegisterViewpoint controller={controller} />
      <EpisodeViewpointSettings tileId="3d-1" />
    </Episode3dViewpointProvider>,
  );
}
...
function RegisterViewpoint({
  ...
  useRegisterEpisode3dViewpoint("3d-1", controller);
  return null;
}

function createController(): Episode3dViewpointController {
