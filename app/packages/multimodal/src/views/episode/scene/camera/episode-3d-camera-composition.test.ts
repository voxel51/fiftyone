...
import {
  captureEpisode3dCameraCompositions,
  resolveEpisode3dCameraComposition,
  type Episode3dBoundsNormalizedCameraComposition,
  type Episode3dTargetRelativeCameraComposition,
} from "./episode-3d-camera-composition";

describe("episode 3D camera composition", () => {
  it("captures target-relative intent before the bounds fallback", () => {
    const compositions = captureEpisode3dCameraCompositions({
  ...
  it("reconstructs a target-relative view in the new recording", () => {
    const composition: Episode3dTargetRelativeCameraComposition = {
      kind: "target-relative",
      relativePosition: [5, 0, 10],
      relativeTarget: [0, 0, 0],
      rotationMode: "position",
  ...
  it("reconstructs bounds-normalized orientation and zoom", () => {
    const composition: Episode3dBoundsNormalizedCameraComposition = {
      distanceInRadii: 2,
