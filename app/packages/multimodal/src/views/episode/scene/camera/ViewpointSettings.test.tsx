...
import ViewpointSettings from "./ViewpointSettings";
import {
...
function renderSettings(controller: Scene3dViewpointController) {
  return render(
    <Scene3dViewpointProvider>
      <RegisterViewpoint controller={controller} />
      <ViewpointSettings tileId="3d-1" />
    </Scene3dViewpointProvider>,
  );
}
...
function RegisterViewpoint({
  ...
  useRegisterScene3dViewpoint("3d-1", controller);
  return null;
}

function createController(): Scene3dViewpointController {
