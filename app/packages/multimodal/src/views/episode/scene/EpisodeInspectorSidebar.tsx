...
import {
  ...
  type EpisodeSelectedImageObject,
  type EpisodeSelectedSceneObject,
 ...
 * object selection (`episodeSelectedObjectAtom`) rather than the focused
 ...
 */
const EpisodeInspectorSidebar: React.FC = () => {
  const selected = useEpisodeSelectedObject();
  const setSelected = useSetAtom(episodeSelectedObjectAtom);
...
function SceneObjectFields({
  ...
  readonly selected: EpisodeSelectedSceneObject;
}) {
...
function ImageObjectFields({
  ...
  readonly selected: EpisodeSelectedImageObject;
}) {
  return (
    <>
...
export default EpisodeInspectorSidebar;
