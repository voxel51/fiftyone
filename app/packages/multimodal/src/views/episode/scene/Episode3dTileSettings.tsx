...
import type { EpisodeImageGeometryMode } from "../image/camera-geometry/episode-camera-model";
import type { PointCloudColorCapabilities } from "./use-point-cloud-color-capabilities";
import type { EpisodePoseTrajectories } from "./episode-pose-trajectories-context";
import {
  checkboxNoSpaceToggleProps,
  settingsBooleanNoSpaceToggleProps,
} from "../settings/episode-settings-keyboard";
import { EpisodeFrameSelect } from "../settings/EpisodeFrameSelect";
import { EpisodeSettingsNumberField } from "../settings/EpisodeSettingsNumberField";
import { EpisodeSettingsSelect } from "../settings/EpisodeSettingsSelect";
...
import { EpisodeSettingsLabel as SettingsLabel } from "../settings/EpisodeSettingsLabel";
import EpisodeViewpointSettings from "./EpisodeViewpointSettings";
import { TRACKING_MODES } from "./use-episode-3d-camera-tracking";

/**
 * One source group shown in the 3D settings sidebar.
 */
export interface Episode3dTileSettingsSourceGroup {
 ...
 */
export interface Episode3dTileSettingsSourceGroups {
  readonly camera: Episode3dTileSettingsSourceGroup;
  readonly mapLayer: Episode3dTileSettingsSourceGroup;
  readonly pointCloud: Episode3dTileSettingsSourceGroup;
  readonly pose: Episode3dTileSettingsSourceGroup;
  readonly sceneAnnotation: Episode3dTileSettingsSourceGroup;
}

/**
 * Tile-local source selection controls for the 3D sidebar.
 */
export interface Episode3dTileSettingsSelectionControls {
 ...
 */
export interface Episode3dTileSettingsPointCloudInputs {
...
export interface Episode3dTileSettingsCameraInputs {
 ...
 */
export interface Episode3dTileSettingsFrameControls {
 ...
 */
export interface Episode3dTileSettingsPoseControls {
  readonly selectedSources: readonly SceneSource[];
 ...
 */
export interface Episode3dTileSettingsTrackingControls {
 ...
 */
export interface Episode3dTileSettingsProps {
  readonly cameraInputs: Episode3dTileSettingsCameraInputs;
  readonly frameControls: Episode3dTileSettingsFrameControls;
  readonly pointCloudInputs: Episode3dTileSettingsPointCloudInputs;
  readonly poseControls: Episode3dTileSettingsPoseControls;
  readonly selection: Episode3dTileSettingsSelectionControls;
  readonly sourceGroups: Episode3dTileSettingsSourceGroups;
  readonly tileId: string | null;
  readonly trackingControls: Episode3dTileSettingsTrackingControls;
}
 ...
 */
const Episode3dTileSettings: React.FC<Episode3dTileSettingsProps> = ({
  cameraInputs,
  frameControls,
  pointCloudInputs,
  poseControls,
...
export default React.memo(Episode3dTileSettings);
