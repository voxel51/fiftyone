...
export interface Scene3dFrameSelectionRestore {
...
export interface Scene3dReferenceAuthority {
 ...
 */
export function useScene3dFrameSelection({
  annotationFrames,
  annotationStreams = [],
  calibrationFrames,
  calibrationStreams = [],
  ...
  readonly poseFrames?: readonly (StreamPlaybackFrame<PoseVisualization> | null)[];
  ...
  readonly referenceAuthority?: Scene3dReferenceAuthority | null;
  readonly restore?: Scene3dFrameSelectionRestore | null;
...
function annotationStreamFrames(
  streams: readonly string[],
  frames: readonly (StreamPlaybackFrame<SceneUpdateVisualization> | null)[],
): readonly StreamFrameObservation[] {
  return frames.map((playbackFrame, index) => ({
    frameIds:
