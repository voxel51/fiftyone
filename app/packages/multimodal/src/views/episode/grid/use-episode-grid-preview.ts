...
export interface EpisodeGridPreviewSnapshot {
 ...
 */
export interface EpisodeGridPreviewState extends EpisodeGridPreviewSnapshot {
 ...
 */
export interface UseEpisodeGridPreviewOptions {
...
export const EPISODE_GRID_BUFFERING_DELAY_MS = 150;

const IDLE_PREVIEW_STATE: EpisodeGridPreviewSnapshot = {
  error: null,
  frame: null,
 ...
 */
export function useEpisodeGridPreview({
  enabled = true,
  hovered = false,
  previewSession,
  ...
  const [state, setState] =
    useState<EpisodeGridPreviewSnapshot>(IDLE_PREVIEW_STATE);
