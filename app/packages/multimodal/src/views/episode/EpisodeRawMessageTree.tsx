...
import styles from "./EpisodeRawMessageTile.module.css";
import { useCopyFeedback } from "./use-copy-feedback";

/** Levels expanded by default; deeper nodes open on demand. */
const AUTO_EXPAND_DEPTH = 2;

export interface EpisodeRawMessageTreeProps {
 ...
 */
const EpisodeRawMessageTree: React.FC<EpisodeRawMessageTreeProps> = ({
...
export default EpisodeRawMessageTree;
