/** Aggregate counters exposed by the MCAP performance-stats panel. */
export interface McapMapPerformanceStats {
...
export function noteMcapMapFollowCommand(): void {
  followCommands += 1;
}

/** Records one imperative playback frame painted into MapLibre. */
export function noteMcapMapPlaybackPaint(): void {
  playbackPaints += 1;
}

/** Records a React commit for either map component boundary. */
export function noteMcapMapReactCommit(surface: "tile" | "surface"): void {
...
export function noteMcapMapSourceUpdate(sourceId: string): void {
...
export function mcapMapPerformanceStats(): McapMapPerformanceStats {
  return {
    followCommands,
    playbackPaints,
    reactCommits: {
...
export function resetMcapMapPerformanceStatsForTests(): void {
  followCommands = 0;
  playbackPaints = 0;
