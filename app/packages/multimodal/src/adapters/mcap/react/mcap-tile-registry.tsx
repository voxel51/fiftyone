 ...
 */
export interface McapTileRegistry<T> {
...
interface McapTileRegistryValue<T> {
 ...
 */
export function createMcapTileRegistry<T>(name: string): McapTileRegistry<T> {
  const Context = createContext<McapTileRegistryValue<T> | null>(null);
