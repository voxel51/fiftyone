...
export interface Mcap3dCameraOrbit {
...
export interface Mcap3dViewpointSnapshot {
...
export interface Mcap3dViewpointStore {
  getSnapshot(): Mcap3dViewpointSnapshot;
  publish(patch: Partial<Mcap3dViewpointSnapshot>): void;
...
export function normalizeMcap3dCameraProjection(
...
export function createMcap3dViewpointStore(
  initial: Mcap3dViewpointSnapshot,
): Mcap3dViewpointStore {
...
function sceneUpVector(axis: Mcap3dSceneUpAxis): Vector3 {
  switch (axis) {
    case "x":
...
function azimuthReference(axis: Mcap3dSceneUpAxis): Vector3 {
...
function viewpointSnapshotsEqual(
  a: Mcap3dViewpointSnapshot,
  b: Mcap3dViewpointSnapshot,
): boolean {
  return (
