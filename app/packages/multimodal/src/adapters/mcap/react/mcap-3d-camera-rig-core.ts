 ...
 */
export interface Mcap3dCameraRigInputs {
  /**
   ...
   */
  readonly adoptAnchor: Mcap3dCameraTrackingAnchor | null;
...
export interface Mcap3dCameraRigCallbacks {
   ...
   */
  readonly onPoseSample: (sample: Mcap3dCameraRigSample) => void;
}
 ...
 */
export class Mcap3dCameraRigController {
  private anchor: Mcap3dCameraTrackingAnchor | null = null;
  /**
  ...
  private inputs: Mcap3dCameraRigInputs;
  private lastAdoptedAnchor: Mcap3dCameraTrackingAnchor | null = null;
  ...
  constructor(
    ...
    private readonly callbacks: Mcap3dCameraRigCallbacks,
    initialInputs: Mcap3dCameraRigInputs,
  ) {
  ...
  getAnchor(): Mcap3dCameraTrackingAnchor | null {
    return this.anchor;
  }
   ...
   */
  sync(inputs: Mcap3dCameraRigInputs): void {
    if (this.disposed) {
      return;
    }
    this.inputs = inputs;
  ...
  private anchorMatchesInputs(anchor: Mcap3dCameraTrackingAnchor): boolean {
  ...
  private compose(targetPose: Mcap3dCameraTargetPose): void {
