...
import type { CameraTargetResolution } from "./mcap-3d-camera";
import {
...
describe("Mcap3dCameraRigController follow composition", () => {
...
describe("Mcap3dCameraRigController external-write protocol", () => {
...
describe("Mcap3dCameraRigController gesture commits", () => {
...
describe("Mcap3dCameraRigController anchor adoption", () => {
...
function createController(scene: ReturnType<typeof createScene>) {
  return new Mcap3dCameraRigController(
    scene.camera,
    scene.controls,
    scene.invalidate,
    scene.callbacks,
...
function rigInputs(
  overrides: Partial<Mcap3dCameraRigInputs> = {},
): Mcap3dCameraRigInputs {
  return {
    adoptAnchor: null,
    mode: "position",
    sceneUpAxis: "z",
