...
interface McapSettingsNumberFieldBaseProps {
 ...
 */
export type McapSettingsNumberFieldProps = McapSettingsNumberFieldBaseProps &
  (
    | {
        readonly empty: "null";
...
/**
 * The one numeric input for MCAP settings surfaces — a Blender-style
 ...
 */
export function McapSettingsNumberField(props: McapSettingsNumberFieldProps) {
  const {
    ariaLabel,
    commitOn = "change",
    disabled = false,
