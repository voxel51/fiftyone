...
import {
  ...
  type McapSettingsNumberFieldProps,
} from "./McapSettingsNumberField";
...
function Harness({
  ...
  onCommit,
  ...props
}: Omit<McapSettingsNumberFieldProps, "ariaLabel" | "onCommit" | "value"> & {
  ...
  return (
    <McapSettingsNumberField
      {...(props as McapSettingsNumberFieldProps)}
      ariaLabel="Value"
...
describe("McapSettingsNumberField", () => {
