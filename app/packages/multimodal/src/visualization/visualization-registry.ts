...
> = Object.freeze({
  ...
  [VISUALIZATION_KIND.ENCODED_AUDIO]: RENDERER_FAMILY.AUDIO,
  ...
  [VISUALIZATION_KIND.NUMERIC_SIGNAL]: RENDERER_FAMILY.PLOT,
  [VISUALIZATION_KIND.TRACK_EVENTS]: RENDERER_FAMILY.TIMELINE,
