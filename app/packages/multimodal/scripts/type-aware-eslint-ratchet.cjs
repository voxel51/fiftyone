...
const migratedPaths = [
  ...
  "packages/multimodal/src/adapters/mcap/resource-client/non-indexed-mcap.integration.test.ts",
  "packages/multimodal/src/adapters/mcap/resource-client/operations/read-frame-transforms.ts",
  "packages/multimodal/src/adapters/mcap/resource-client/inline-client.frame-transform-bootstrap.test.ts",
  "packages/multimodal/src/adapters/mcap/resource-client/inline-client.frame-transform-window.test.ts",
