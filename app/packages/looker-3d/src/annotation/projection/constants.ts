/** Opacity for annotations in their normal (idle) state */
...
/** SVG stroke-dasharray value used to indicate a selected annotation */
export const SELECTED_DASH_ARRAY = "5,5";
