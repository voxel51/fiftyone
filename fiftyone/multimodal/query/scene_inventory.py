...
def resolve_scene_inventory(
    ...
    This is currently a deterministic smoke-test implementation. The shape is
    intentionally source-agnostic so real source adapters can replace the mock
    resolver without changing the server or app query contract.
    """
