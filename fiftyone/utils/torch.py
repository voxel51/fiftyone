...
def apply_torch_image_model(
    samples, model, label_field, confidence_thresh=None
):
    ...
    data_loader = _make_data_loader(samples, model.transforms, batch_size)
...
def _make_data_loader(samples, transforms, batch_size, force_rgb=True):
    image_paths = []
