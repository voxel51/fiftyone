...
_VITB32 = dict(
    ...
    datacomp_xl_s13b_b90k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-DataComp.XL-s13B-b90K/"
    ),
    # DataComp-M models
    datacomp_m_s128m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-DataComp.M-s128M-b4K/"
    ),
    ...
    commonpool_m_s128m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.M-s128M-b4K/"
    ),
    # DataComp-S models
    datacomp_s_s13m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-DataComp.S-s13M-b4K/"
    ),
    ...
    commonpool_s_s13m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.S-s13M-b4K/"
    ),
)
...
_VITB32_256 = dict(
    datacomp_s34b_b86k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-256x256-DataComp-s34B-b86K/"
    ),
)
...
_VITB16 = dict(
    ...
    # DataComp-XL models
    datacomp_xl_s13b_b90k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-16-DataComp.XL-s13B-b90K/"
    ),
    # DataComp-L models
    ...
    commonpool_l_s1b_b8k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-16-CommonPool.L-s1B-b8K/"
    ),
    # DFN
...
_VITL14 = dict(
    ...
    # DataComp-XL models
    datacomp_xl_s13b_b90k=_pcfg(
        hf_hub="laion/CLIP-ViT-L-14-DataComp.XL-s13B-b90K/"
    ),
...
_VITbigG14 = dict(
    laion2b_s39b_b160k=_pcfg(
        hf_hub="laion/CLIP-ViT-bigG-14-laion2B-39B-b160k/"
    ),
)
...
_convnext_base = dict(
    laion400m_s13b_b51k=_pcfg(
        hf_hub="laion/CLIP-convnext_base-laion400M-s13B-b51K/"
    ),
)

_convnext_base_w = dict(
    laion2b_s13b_b82k=_pcfg(
        hf_hub="laion/CLIP-convnext_base_w-laion2B-s13B-b82K/"
    ),
...
_PRETRAINED = {
    ...
    "ViT-bigG-14-CLIPA-336": dict(
        datacomp1b=_apcfg(
            hf_hub="UCSC-VLAA/ViT-bigG-14-CLIPA-336-datacomp1B/"
        ),
    ),
    "nllb-clip-base": dict(
