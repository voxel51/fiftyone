...
def apply_model(
    samples, model, label_field, confidence_thresh=0.1, batch_size=None
):
    ...
    Args:
        ...
        label_field: the name (or prefix) of the field in which to store the
            model predictions
        confidence_thresh (0.1): a confidence threshold to apply to any
            applicable labels generated by the model. Can be ``None`` if you do
            not wish to apply any thresholding
