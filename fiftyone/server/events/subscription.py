...
class LocalSubscriptionRegistry(ABC):
    ...
    def subscribe(
        ...
        """
        Registers a subscription for a given channel.
    ...
    def unsubscribe_all(self, channel: str):
        """
        Unsubscribes all subscriptions for a given channel.
        """
        pass
    ...
    def get_subscribers(
        ...
        """
        Retrieves all subscriptions for a given channel.
...
class InLocalMemorySubscriptionRegistry(LocalSubscriptionRegistry):
    def __init__(self):
        ...
        # list of subscribers for a channel
    ...
    def unsubscribe(self, subscription_id: str) -> bool:
        with self._lock:
            for channel, subs in self._registry.items():
