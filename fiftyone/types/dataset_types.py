...
class FiftyOneDataset(Dataset):
    ...
    :meth:`fiftyone.core.sample.Sample.to_dict`, ``evaluations/`` contains any
...
class FiftyOneBatchDataset(Dataset):
    """A disk representation of an entire
    :class:`fiftyone.core.dataset.Dataset` that is optimized for efficient
    batch import/export.
    ...
    def get_dataset_importer_cls(self):
        ...
        return foud.FiftyOneBatchDatasetImporter

    def get_dataset_exporter_cls(self):
        import fiftyone.utils.data as foud

        return foud.FiftyOneBatchDatasetExporter
