...
class OpenImagesDataset(ImageDetectionDataset):
    """A labeled dataset consisting of images and their associated image labels
    and bounding boxes stored as a directory of images and label .CSV files.
    ...
    where the CSV files have the following format::
        ...
        class-descriptions-boxable.csv
                ...
                <MID label 1>,<descriptive label 1>
                <MID label 2>,<descriptive label 2>
    ...
    def get_dataset_importer_cls(self):
        import fiftyone.utils.open_images as fouo
    ...
    def get_dataset_exporter_cls(self):
        ...
        return fouo.OpenImagesDatasetExporter
