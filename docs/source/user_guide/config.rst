...
|                               |                                       |                               | FiftyOne Enterprise SDK in :ref:`API connection mode <teams-api-connection>`, which    |
|                               |                                       |                               | targets a size of `batcher_target_size_bytes` for each call. `static` uses a fixed     |
|                               |                                       |                               | batch size of `batcher_static_size`.                                                   |
+-------------------------------+---------------------------------------+-------------------------------+----------------------------------------------------------------------------------------+
