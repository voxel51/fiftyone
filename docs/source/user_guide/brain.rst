...
natural clusters of objects, such as visually similar carrots, large groups of
people, and small/distant people.
...
For some similarity backends (including the default backend), the
|SimilarityIndex| object returned by
:meth:`compute_similarity() <fiftyone.brain.compute_similarity>` also provides
powerful
:meth:`find_unique() <fiftyone.brain.similarity.SimilarityIndex.find_unique>`
and
:meth:`find_duplicates() <fiftyone.brain.similarity.SimilarityIndex.find_duplicates>`
...
By default, all similarity indexes are generated using a builtin
...
-   **sklearn** (*default*): an `scikit-learn <https://scikit-learn.org>`_
    backend
-   **qdrant**: a `Qdrant <https://github.com/qdrant/qdrant>` backend
-   **pinecone**: a `Pinecone <https://www.pinecone.io>`_ backend
...
:meth:`visualize_unique() <fiftyone.brain.similarity.SimilarityIndex.visualize_unique>`
...
The
:meth:`neighbors_map <fiftyone.brain.similarity.SimilarityIndex.neighbors_map>`
...
:meth:`duplicates_view() <fiftyone.brain.similarity.SimilarityIndex.duplicates_view>`
