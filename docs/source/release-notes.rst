...
- Added new
  ...
  :meth:`unique_view() <fiftyone.brain.similarity.SimilarityIndex.unique_view>`, and
  :meth:`visualize_unique() <fiftyone.brain.similarity.SimilarityIndex.visualize_unique>`
  methods to the
  :class:`SimilarityIndex <fiftyone.brain.similarity.SimilarityIndex>`
  object returned by
...
- Added new
  :meth:`find_duplicates() <fiftyone.brain.similarity.SimilarityIndex.find_duplicates>`,
  :meth:`duplicates_view() <fiftyone.brain.similarity.SimilarityIndex.duplicates_view>`, and
  :meth:`visualize_duplicates() <fiftyone.brain.similarity.SimilarityIndex.visualize_duplicates>`
  methods to the
  :class:`SimilarityIndex <fiftyone.brain.similarity.SimilarityIndex>`
  object returned by
  :meth:`compute_similarity() <fiftyone.brain.compute_similarity>` that enable
