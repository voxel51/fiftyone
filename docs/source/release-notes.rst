...
Includes all updates from :ref:`FiftyOne 2.6.1 <release-notes-v2.6.1>`, plus:

- Per-user cloud credentials support masks and 3d media
- Security fixes for: nextjs, cookie, cross-spawn, lodash
...
- Optimized modal tagger to support massive datasets `#5417 <https://github.com/voxel51/fiftyone/pull/5417>`_ 
- Fixed a bug with sample updates after tagging in the modal `#5514 <https://github.com/voxel51/fiftyone/pull/5514>`_
