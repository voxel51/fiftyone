...
- Added support for programmatically configuring the App's sidebar groups and
  ...
  `#2190 <https://github.com/voxel51/fiftyone/pull/2190>`
...
- Added support for declaring custom dynamic embedded document fields on
  dataset schemas `#1825 <https://github.com/voxel51/fiftyone/pull/1825>`

- Added support for storing field-level descriptions on datasets
  `#2216 <https://github.com/voxel51/fiftyone/pull/2216>`_

- Added native support for installing on Apple Silicon!
  `#2165 <https://github.com/voxel51/fiftyone/pull/2165>`

- Dataset creation using default naming is now multiprocess-safe
  <#2097 <https://github.com/voxel51/fiftyone/pull/2097>`

- Optimized the implementation of tagging samples/labels via the App and the
  API `#2203 <https://github.com/voxel51/fiftyone/pull/2203>` and
  `#2208 <https://github.com/voxel51/fiftyone/pull/2208>`
...
- Added an option to import annotation IDs when loading data stored in
  ...
  `#2122 <https://github.com/voxel51/fiftyone/pull/2122>`
...
- Added support for including the export directory in the `dataset.yaml` file
  ...
  `#2114 <https://github.com/voxel51/fiftyone/pull/2114>`

Annotation

- Updated the default CVAT endpoint to app.cvat.ai
  `#2228 <https://github.com/voxel51/fiftyone/pull/2228>`
