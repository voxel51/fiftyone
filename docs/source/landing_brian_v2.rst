...
.. raw:: html
  ...
  <style>
    ...
    .hero-heading { font-size: 2.4rem !important; font-weight: 700 !important; margin-bottom: 50px !important; }
    ...
    <table id="social-links-table">
      ...
      <th>
        <a href="enterprise/index.html">
          ...
          &nbsp;<span style="white-space:nowrap">Explore FiftyOne Enterprise</span>
        </a>
      </th>
    </table>
  </div>
    ...
    <div class="capability-section">
      <div class="capability-row">
        <div class="capability-text">
          <h3>Visualize</h3>
          <p>Explore your data in the FiftyOne App. Reveal hidden structure with embedding visualizations, mine hard samples, and discover patterns across your datasets.</p>
        ...
        <div class="capability-image">
          <img src="_static/images/homepage_embeddings.gif" alt="Visualize" loading="lazy" />
        </div>
      </div>
      ...
      <div class="capability-row">
        <div class="capability-text">
          <h3>Curate</h3>
          <p>Use FiftyOne's powerful dataset import and manipulation capabilities to manage your data with ease. Spend less time wrangling data and more time building models.</p>
          <a href="user_guide/import_datasets.html" class="capability-cta">Learn how to import data into FiftyOne &rarr;</a>
        </div>
        <div class="capability-image">
          <img src="_static/images/homepage_curate.gif" alt="Curate" loading="lazy" />
        </div>
      </div>
      <div class="capability-row reverse">
        <div class="capability-text">
...
.. raw:: html
  ...
  (function() {
    function fixIntegrations() {
      // Move overflow children back to parent
    ...
    // Try multiple times to catch late-running JS
