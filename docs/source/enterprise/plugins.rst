...
:ref:`Samples toolbar <enterprise-using-datasets>` under your dataset name.
...
.. note::
    ...
    name, not label. For instance, searching 'bright' will only match the operator name (e.g., *@voxel51/panels/compute_brightness*) and not the label *compute_brightness*.
