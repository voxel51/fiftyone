...
This version contains images, bounding boxes, segmentations, and keypoints for
...
-   Tags: ``image, detection, segmentation, keypoint``
...
-   **label_types** (*None*): a label type or list of label types to load.
    Supported values are ``("detections", "segmentations", "keypoints")``. By
